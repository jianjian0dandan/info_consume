...
Draw_pie_all0:function(data){
  ...
  Draw_user_influence_detail:function(data){
    ...
    html += '<td style="text-align:center" id="sum_yc_zf">'+data['origin_weibo_retweeted_total_number']+'</td>';
    html += '<td style="text-align:center" >'+data['origin_weibo_retweeted_average_number'].toFixed(0)+'</td>';
    html += '<td style="text-align:center">'+data['origin_weibo_retweeted_top_number']+'</td>';
    html += '<td style="text-align:center">'+data['origin_weibo_retweeted_brust_average'].toFixed(0)+'</td>';
    html += '<td style="text-align:center" id="sum_yc_pl">'+data['origin_weibo_comment_total_number']+'</td>';
    html += '<td style="text-align:center">'+data['origin_weibo_comment_average_number'].toFixed(0)+'</td>';
    html += '<td style="text-align:center">'+data['origin_weibo_comment_top_number']+'</td>';
    html += '<td style="text-align:center">'+data['origin_weibo_comment_brust_average'].toFixed(0)+'</td>';
    html += '</tr>';
    html += '<tr><th style="text-align:center">转发微博 ('+data['retweeted_weibo_number']+')</th>';
    html += '<td style="text-align:center" id="sum_zf_zf">'+data['retweeted_weibo_retweeted_total_number']+'</td>';
    html += '<td style="text-align:center">'+data['retweeted_weibo_retweeted_average_number'].toFixed(0)+'</td>';
    html += '<td style="text-align:center">'+data['retweeted_weibo_retweeted_top_number']+'</td>';
    html += '<td style="text-align:center">'+data['retweeted_weibo_retweeted_brust_average'].toFixed(0)+'</td>';
    html += '<td style="text-align:center" id="sum_zf_pl">'+data['retweeted_weibo_comment_total_number']+'</td>';
    html += '<td style="text-align:center">'+data['retweeted_weibo_comment_average_number'].toFixed(0)+'</td>';
    html += '<td style="text-align:center">'+data['retweeted_weibo_comment_top_number']+'</td>';
    html += '<td style="text-align:center">'+data['retweeted_weibo_comment_brust_average'].toFixed(0)+'</td>';
    html += '</tr>';
    html += '</table>';
