console.log("【我的影响力】start load:"+getSystemTime());
var domain_rank = 0;
var allfield_rank = 0;
...
var influSkill_url = '/influence_application/specified_user_active/?date='+getNowFormatDate()+'&uid='+uid;      
  Influence.call_ajax_request(influSkill_url, Influence.ajax_method, Influence.influ_skill);
console.log("【我的影响力】end load:"+getSystemTime());
