...
function location_all(){
    ...
    function location_day(data){
        ...
        if (i == 5) break;
            ...
            html += '<td style="text-align:center">' + location_geo[i][0] + '(' + location_geo[i][1] + ')</td>';
        }
        while (i < 5){
            html += '<td style="text-align:center">-</td>';
            i++;
        }
        html += '<td style="text-align:center"><a id="daily_location_map" href="#map">查看地图</a></td>';
        html += '</tr>';
    }
    ...
    function location_week(data){
        ...
        html += '<td style="text-align:center"><a id="weekly_location_map" href="#map">查看地图</a></td>';
    }
    ...
    function location_month(data){
        ...
        html += '<td style="text-align:center"><a id="monthly_location_map" href="#map">查看地图</a></td>';
        html += '</tr>';
        // track map
        ...
        function bind_map(){
            ...
            $('#more_track').click(function(){
                ...
                if(div1.style.display=='none'){
                  var a = $('#more_t_list').css('height');
                 div0.style.height=div0.offsetHeight+parseInt(a)+'px';
                }                
	...
	$('#map').css('display', 'block');
        ...
        $('#unfold_map').click(function(){
             $('#map').css('display','none');
             $('#unfold_map').css('display','none');
              var div0 = document.getElementById('active_geo');  
                 div0.style.height=div0.offsetHeight-850+'px';
