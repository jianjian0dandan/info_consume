...
function seed_single_user_data(){
    ...
    if($('#seed_user input[name="hop_choose"]').attr("disabled") == 'disabled' ){
    //if($('#advanced_condition').attr('display') == 'none'){
        url += '&extend_mark=0';
        url += '&attribute_weight=0&structure_weight=0'
...
function seed_multi_user_data(){
    ...
    //if ($('#advanced_condition').hasClass('hidden')){
        ...
        //upload_job['attribute_weight'] = '0';
        //upload_job['structure_weight'] = '0';
    }
    else{
        upload_job['extend'] = '1';
        //attribute
