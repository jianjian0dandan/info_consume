...
Search_weibo_result.prototype = {
  ...
  Draw_table: function(data){
    ...
    html += '<thead><tr><th>用户ID</th>';
    html += '<th>昵称</th>';
    html += '<th>注册地</th>';
    html += '<th>活跃度</th>';
    html += '<th>身份敏感度</th>';
    html += '<th>影响力</th>';
    html += '<th>相关度</th><th>' + '<input name="choose_all" id="choose_all" type="checkbox" value="" onclick="choose_all()" />' + '</th></tr></thead>';
    html += '<tbody>';
