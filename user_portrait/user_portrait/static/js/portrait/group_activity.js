...
function Draw_top_place(start,end){
    ...
    if((start[i][0].indexOf(a)>=0) || (start[i][0].indexOf(b)<0)){
    continue;
    }
    ...
    if((end[i][0].indexOf(a)>=0) || (end[i][0].indexOf(b)<0) ){
    continue;
    }
        ...
        function drawline(){
            ...
            if (direction == 'in'){
                for (var i = 1; i < geolist.length; i++){
                    var geoname = geolist[i];
                    if (newgeo[geoname]){
                        newlinklist.push([{name:short_city},{name:geoname, value:valuelist[i]}]);
                    }
                }
            }
            else{
                for (var i = 1; i < geolist.length; i++){
                    var geoname = geolist[i];
                    if (newgeo[geoname]){
                        newlinklist.push([{name:geoname},{name:short_city, value:valuelist[i]}]);
                    }
                }
            }
    ...
    function (echarts, BMapExtension) {
        ...
        function drawline(){
            ...
            for (var i = 1; i < geolist.length; i++){
                var geoname = geolist[i];
                if (newgeo[geoname]){
                    linklist.push([{name:last_geo},{name:geoname, value:90}]);
                    last_geo = geolist[i];
                }
            }
