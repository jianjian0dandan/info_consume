...
function draw_character(data){
    ...
    var html = '';
    html += '<div style="font-weight:blod;"><i class="icon iconfont"  style="font-weight:bold; font-size: 20px;color:#77ACF4;">&#xe616;</i><u><b>根据情绪特征划分为：</b><u></div>';
    html += '<div style="margin-top:20px;"><center>'
    for (var i = 0; i < sentiment_dict.length; i++){
        var key = sentiment_dict[i]
        if (key == character_sent){
           if(key=='未知'){
              html += '<span class="group_block">正常</span>';
           }
           else{html += '<span class="group_block">' + key + '</span>';
           }
        }
        else{
          if(key=='未知'){
            html += '<span style="background-color:gray;" class="group_block">正常</span>';
          }else{
    ...
    var html = '';
    html += '<div><i class="icon iconfont"  style="font-weight:bold; font-size: 20px;color:#77ACF4;">&#xe616;</i><u><b>根据语言特征划分为：</b><u></div>';
    html += '<div style="margin-top:20px;"><center>'
