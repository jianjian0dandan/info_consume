...
from micro_prediction.time_series_data import predict_event
    ...
    while  True:
        ...
        if not task:
            ...
            if exist_flag:
                ...
                weibo_es.update(index=topic_index_name,doc_type=topic_index_type,id=task_id,body={'doc':{'comput_status':-7}})
                predict_event(en_name,start_ts,end_ts)
                print 'finish predict event'
                #finish compute
